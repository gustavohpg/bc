...
public class PiadaService {
    ...
    private void popularPiadas() {
        piadas.add(new Piada(1,"Qual tempero é odiado pelos outros? O sal grosso! V2"));
        piadas.add(new Piada(2,"Qual é o nome da cidade que molha os bêbados quando chove? BarSemLona V2"));
piadas.add(new Piada(3,"Piada 3"));
    }
}
